...
for(idx in seq_along(matrix_list)){
  ...
  test_that("colAnys works", {
    ...
    expect_equal(colAnys(sp_mat, na.rm=TRUE, value = FALSE), MatrixGenerics::colAnys(array(as.logical(mat), dim = dim(mat)), na.rm=TRUE, value = FALSE))
  ...
  test_that("colAlls works", {
    ...
    expect_equal(colAlls(sp_mat, na.rm=TRUE, value = FALSE), MatrixGenerics::colAlls(array(as.logical(mat), dim = dim(mat)), na.rm=TRUE, value = FALSE))
