...
The goal of `sparseMatrixStats` is to make the API of the [matrixStats](https://github.com/HenrikBengtsson/matrixStats) available
for sparse matrices.
...
The package uses modern C++ and thus requires a compiler that supports the C++14 standard. On Windows, it might
be necessary to add the following lines to the `%HOMEPATH%/Documents/.R/Makevars.win` file:
...
See also the section of the _Writing R Extensions_ manual on [C++14](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Using-C_002b_002b14-code).
