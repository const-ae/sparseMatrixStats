...
dgCMatrix_rowSums2_col_select <- function(matrix, na_rm, col_selector) {
    .Call('_sparseMatrixStats_dgCMatrix_rowSums2_col_select', PACKAGE = 'sparseMatrixStats', matrix, na_rm, col_selector)
}
